...
<head>
    ...
    <title>Profil pemilikkos | Kosan Ciamiz</title>
...
<body>
    ...
    <section id="contact" class="">
        <div class="container">
            ...
            <form method="post">
                <?php
                $currentUser = $_SESSION['pemilikkos_name'];
